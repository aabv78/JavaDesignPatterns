...
public class _AdapterMain {
	...
	//	In order to transfer them you need some kind of adapter that is compatible with your computer ports so that
	//	you can attach memory card to your computer. In this case card reader is an adapter.
