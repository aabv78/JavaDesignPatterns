...
public class _FactoryMethodMain {
	...
	//	When to use?
	//	Useful when there is some generic processing in a class but the required sub-class is dynamically decided at runtime. Or putting
	//	it in other words, when the client doesn't know what exact sub-class it might need.
